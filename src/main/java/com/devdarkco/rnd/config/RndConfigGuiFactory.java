...
public class RndConfigGuiFactory implements IModGuiFactory {
    ...
    public static class RndConfigGui extends GuiConfig {
        ...
        public RndConfigGui(GuiScreen parentScreen) {
            super(parentScreen, getConfigElements(), RndConstants.MODID, false, false, I18n.format("gui.config.main_title"));
        }
