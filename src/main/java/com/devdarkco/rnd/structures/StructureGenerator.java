package com.devdarkco.rnd.structures;
...
public class StructureGenerator extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, BlockPos position) {
        ...
        Template template = worldServer.getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation(RndConstants.MODID, structureName));

        if (template == null) {
            Debug.l("The structure template: " + this.structureName + " did not exist!");
            return false;
        }
